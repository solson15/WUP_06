...
in the fisher XY test all the P-values were different and are all very low. the p value for white and other is 0.002607. the p value for black and other is 0.001564. 



# Discussion and Conclusion

In this branch the visual graphs were very similar to the 2nd branches graphs. The ratios are similarly close to one another in the branches. The slight difference would be the other category. Its ratio is a little higher in the 2nd branch. All p values for the fisherXY test came back significantly which is different to that of the 2nd.
